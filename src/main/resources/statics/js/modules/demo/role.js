$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            { label: '角色描述', name: 'description', width: 100 },
            { label: '角色状态', name: 'status', index: "status", width: 80, formatter: function(status){
            	if(status === 0){
        ...
        menuTree: function(){
            layer.open({
                ...
                btn1: function (index) {
                    ...
                    //选择上级菜单
                    vm.menu.menuId = node[0].menuId;
                    vm.menu.menuName = node[0].name;
                    layer.close(index);
                }
            });
        },
