 ...
 * 
 * @ClassName SbRecord
 * @Description TODO(申博视讯实体类)
 * @author Hardy
 * @Date 2019年5月15日 上午12:23:40
 * @version 1.0.0
 */
public class SbRecord extends ResultCommonField{
    private static final long serialVersionUID = 8177809259429747332L;
