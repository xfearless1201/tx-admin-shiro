 ...
 * 
 * @ClassName CgRecord
 * @Description TODO(CG视讯实体类)
 * @author Hardy
 * @Date 2019年5月13日 下午6:38:07
 * @version 1.0.0
 */
public class CgRecord extends ResultCommonField{
    
    private static final long serialVersionUID = -3779995549361647601L;
